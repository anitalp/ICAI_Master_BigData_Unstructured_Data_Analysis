...
#------------------------------
elist <- c()
ht <- read.csv("C:/Users/ana_2/OneDrive/Documentos/ht_unsort_healthykids.csv", sep = ",", stringsAsFactors = FALSE, header = T, fileEncoding = "UTF-8")
...
#Subgraph
graph3 <- induced.subgraph(graph2, which(dgr>100)) #80
